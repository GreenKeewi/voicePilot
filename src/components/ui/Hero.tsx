    ...
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
        ...
        <h1 className="mt-8 text-center text-5xl font-semibold tracking-tighter text-gray-900 sm:text-8xl sm:leading-22">
          <FadeSpan>Never</FadeSpan> <FadeSpan>Miss</FadeSpan> <FadeSpan>a</FadeSpan>
          <br />
          <FadeSpan>Customer</FadeSpan> <FadeSpan>Call</FadeSpan> <FadeSpan>Again.</FadeSpan>
        </h1>
        <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
          <FadeSpan>AI call agents that answer questions, book</FadeSpan>{" "}
          <FadeSpan>appointments, and support customers 24/7 —</FadeSpan>{" "}
          <FadeSpan>built for small businesses.</FadeSpan>
        </p>
        <FadeDiv className="mt-6 flex flex-wrap gap-4 justify-center">
          <a
            className="inline-flex cursor-pointer flex-row items-center justify-center gap-1 rounded-md border-b-[1.5px] border-teal-700 bg-linear-to-b from-teal-400 to-teal-500 px-5 py-3 leading-4 font-medium tracking-wide whitespace-nowrap text-white shadow-[0_0_0_2px_rgba(0,0,0,0.04),0_0_14px_0_rgba(255,255,255,0.19)] transition-all duration-200 ease-in-out hover:shadow-teal-300"
            href="#"
          >
            Try the Demo
          </a>
